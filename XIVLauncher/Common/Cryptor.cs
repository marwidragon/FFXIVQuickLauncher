...
namespace XIVLauncher.Common
{
    public class Cryptor
    {
        ...
        /// 初期Salt
        /// </summary>
        private const string DefaultSalt = "~P.jg7yj$UC,jV~v5KcAHsDe)mc(VLFV";

        /// <summary>
        /// 初期パスワード
        /// </summary>
        private const string DefaultPassword = "rFDE3LLxJ-.yCn2rETv!/brYZJ-RitR~";
            ...
            string password = DefaultPassword)
        {
            ...
            {
                byte[] key, iv;
                Cryptor.GenerateKeyFromPassword(password, rijndael.KeySize, out key, rijndael.BlockSize, out iv);
                rijndael.Key = key;
                rijndael.IV = iv;
